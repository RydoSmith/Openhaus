<div class="container" style="padding-top: 100px;">
    <div class="row">
        <div class="col s12 m12 l12">
            <ul class="user-nav">
                ...
                <li><a href="/user/myevents" class="selected">My Events</a></li>
    ...
    <div class="row">
        <div class="col s2 m2 l2">
            <a href="#!" style="text-align: center; display: block; margin: 20px 0px" data-page="page-1" class="change-page">My Events</a>
            <a href="#!" style="text-align: center; display: block;" data-page="page-2" class="change-page">Previous Open Houses</a>
        </div>
        <div class="col s10 m10 l10">
            <div class="dashboard-panel" id="page-1">
                <div class="dashboard-panel-heading teal">
                    <h6 class="white-text" style="width: 100%">My Events</h6>
                </div>
                    ...
                    <?php if($model->current_events): ?>
                        <?php foreach($model->current_events as $event): ?>
                            <p>
                                ...
                                <span class="blue-grey-text" style="margin-left: 20px; float: right; font-size: 12px; line-height: 32px;"><?=date('D, jS M', strtotime($event['rspv_date']['date']))?> at <?=date('ga', strtotime($event['rspv_date']['start_time']))?></span>
                            </p>
                        <?php endforeach; ?>
                    <?php else: ?>
            ...
            <div class="dashboard-panel" style="display: none;" id="page-2">
                <div class="dashboard-panel-heading teal">
                    <h6 class="white-text" style="width: 100%">Previous Open Houses</h6>
                </div>
                <div class="dashboard-panel-body" style="height: 500px;">
